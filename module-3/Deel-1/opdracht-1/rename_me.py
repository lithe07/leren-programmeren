...
def even_oneven(stellar_broccoli:int) -> bool:
    return stellar_broccoli % 2 == 0

# Deze functie reverse het zin 
def reverse_zin(fantasie_platypus:str) -> str:
...
def herhaald_optellen(galactische_snoepjes:str) -> int:
...
def optellen_met_komma(planetair_taartje:str) -> float:
...
def getal_keren(infinity_pizza:int, parallelle_tosti:int=10) -> None:
